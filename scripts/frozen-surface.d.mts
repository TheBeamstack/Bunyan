 ...
 * the `docs/CURRENT_STATE.md` §7 entry that authorises the rewrite, and it used to be inherited and stale
 ...
 *
 * ⚠ `abstracts` is `recordedAbstracts(root)` — §7 PLUS `docs/PHASE_LOG.md` — never the §7 parse alone.
