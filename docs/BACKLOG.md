...
- implements: this file's `## Discovered` entries of 2026-08-19 and 2026-08-21 (`agent-finish.mjs --review`
  stamps the row `done`) · `scripts/seats.mjs`'s `reviewFlipsToDone` · `scripts/reserved-classes.mjs` ·
  `AGENTS.md §5`
- verify: `pnpm verify`
- done-when:
